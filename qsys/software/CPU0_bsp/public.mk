...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../cpu2core.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4002038
SOPC_SYSID_FLAG += --sidp=0x4002038
ELF_PATCH_FLAG  += --sidp 0x4002038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1446731318
SOPC_SYSID_FLAG += --timestamp=1446731318
ELF_PATCH_FLAG  += --timestamp 1446731318
