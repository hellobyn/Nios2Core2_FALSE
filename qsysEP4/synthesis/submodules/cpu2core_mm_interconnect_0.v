...
// 
// Generated using ACDS version 14.1 186 at 2015.11.05.21:48:55
...
module cpu2core_mm_interconnect_0 (
		...
		input  wire [26:0] cpu0_data_master_address,                    //                      cpu0_data_master.address
		...
		input  wire [26:0] cpu0_instruction_master_address,             //               cpu0_instruction_master.address
	...
	wire   [26:0] cpu0_data_master_translator_avalon_universal_master_0_address;              // cpu0_data_master_translator:uav_address -> cpu0_data_master_agent:av_address
	...
	wire          rsp_mux_src_valid;                                                          // rsp_mux:src_valid -> cpu0_data_master_agent:rp_valid
	wire  [102:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> cpu0_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                          // cpu0_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [6:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> cpu0_data_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                  // rsp_mux:src_startofpacket -> cpu0_data_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                    // rsp_mux:src_endofpacket -> cpu0_data_master_agent:rp_endofpacket
	...
	wire   [26:0] cpu0_instruction_master_translator_avalon_universal_master_0_address;       // cpu0_instruction_master_translator:uav_address -> cpu0_instruction_master_agent:av_address
	...
	wire   [26:0] cpu0_debug_mem_slave_agent_m0_address;                                      // cpu0_debug_mem_slave_agent:m0_address -> cpu0_debug_mem_slave_translator:uav_address
	...
	wire  [103:0] cpu0_debug_mem_slave_agent_rf_source_data;                                  // cpu0_debug_mem_slave_agent:rf_source_data -> cpu0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [103:0] cpu0_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu0_debug_mem_slave_agent_rsp_fifo:out_data -> cpu0_debug_mem_slave_agent:rf_sink_data
	...
	wire          cpu0_debug_mem_slave_agent_rdata_fifo_src_valid;                            // cpu0_debug_mem_slave_agent:rdata_fifo_src_valid -> cpu0_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] cpu0_debug_mem_slave_agent_rdata_fifo_src_data;                             // cpu0_debug_mem_slave_agent:rdata_fifo_src_data -> cpu0_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          cpu0_debug_mem_slave_agent_rdata_fifo_src_ready;                            // cpu0_debug_mem_slave_agent:rdata_fifo_sink_ready -> cpu0_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_002_src_valid;                                                      // cmd_mux_002:src_valid -> cpu0_debug_mem_slave_agent:cp_valid
	wire  [102:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> cpu0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                      // cpu0_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> cpu0_debug_mem_slave_agent:cp_channel
	...
	wire   [26:0] epcs_epcs_control_port_agent_m0_address;                                    // epcs_epcs_control_port_agent:m0_address -> epcs_epcs_control_port_translator:uav_address
	...
	wire  [103:0] epcs_epcs_control_port_agent_rf_source_data;                                // epcs_epcs_control_port_agent:rf_source_data -> epcs_epcs_control_port_agent_rsp_fifo:in_data
	...
	wire  [103:0] epcs_epcs_control_port_agent_rsp_fifo_out_data;                             // epcs_epcs_control_port_agent_rsp_fifo:out_data -> epcs_epcs_control_port_agent:rf_sink_data
	...
	wire          epcs_epcs_control_port_agent_rdata_fifo_src_valid;                          // epcs_epcs_control_port_agent:rdata_fifo_src_valid -> epcs_epcs_control_port_agent:rdata_fifo_sink_valid
	wire   [33:0] epcs_epcs_control_port_agent_rdata_fifo_src_data;                           // epcs_epcs_control_port_agent:rdata_fifo_src_data -> epcs_epcs_control_port_agent:rdata_fifo_sink_data
	wire          epcs_epcs_control_port_agent_rdata_fifo_src_ready;                          // epcs_epcs_control_port_agent:rdata_fifo_sink_ready -> epcs_epcs_control_port_agent:rdata_fifo_src_ready
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> epcs_epcs_control_port_agent:cp_valid
	wire  [102:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> epcs_epcs_control_port_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // epcs_epcs_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [6:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> epcs_epcs_control_port_agent:cp_channel
	...
	wire   [26:0] timer0_s1_agent_m0_address;                                                 // timer0_s1_agent:m0_address -> timer0_s1_translator:uav_address
	...
	wire          timer0_s1_agent_rdata_fifo_src_valid;                                       // timer0_s1_agent:rdata_fifo_src_valid -> timer0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] timer0_s1_agent_rdata_fifo_src_data;                                        // timer0_s1_agent:rdata_fifo_src_data -> timer0_s1_agent:rdata_fifo_sink_data
	wire          timer0_s1_agent_rdata_fifo_src_ready;                                       // timer0_s1_agent:rdata_fifo_sink_ready -> timer0_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_005_src_valid;                                                      // cmd_mux_005:src_valid -> timer0_s1_agent:cp_valid
	wire  [102:0] cmd_mux_005_src_data;                                                       // cmd_mux_005:src_data -> timer0_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                      // timer0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> timer0_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                              // cmd_mux_005:src_startofpacket -> timer0_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                // cmd_mux_005:src_endofpacket -> timer0_s1_agent:cp_endofpacket
	wire   [31:0] pio0_s1_agent_m0_readdata;                                                  // pio0_s1_translator:uav_readdata -> pio0_s1_agent:m0_readdata
	wire          pio0_s1_agent_m0_waitrequest;                                               // pio0_s1_translator:uav_waitrequest -> pio0_s1_agent:m0_waitrequest
	wire          pio0_s1_agent_m0_debugaccess;                                               // pio0_s1_agent:m0_debugaccess -> pio0_s1_translator:uav_debugaccess
	wire   [26:0] pio0_s1_agent_m0_address;                                                   // pio0_s1_agent:m0_address -> pio0_s1_translator:uav_address
	wire    [3:0] pio0_s1_agent_m0_byteenable;                                                // pio0_s1_agent:m0_byteenable -> pio0_s1_translator:uav_byteenable
	wire          pio0_s1_agent_m0_read;                                                      // pio0_s1_agent:m0_read -> pio0_s1_translator:uav_read
	wire          pio0_s1_agent_m0_readdatavalid;                                             // pio0_s1_translator:uav_readdatavalid -> pio0_s1_agent:m0_readdatavalid
	wire          pio0_s1_agent_m0_lock;                                                      // pio0_s1_agent:m0_lock -> pio0_s1_translator:uav_lock
	wire   [31:0] pio0_s1_agent_m0_writedata;                                                 // pio0_s1_agent:m0_writedata -> pio0_s1_translator:uav_writedata
	wire          pio0_s1_agent_m0_write;                                                     // pio0_s1_agent:m0_write -> pio0_s1_translator:uav_write
	wire    [2:0] pio0_s1_agent_m0_burstcount;                                                // pio0_s1_agent:m0_burstcount -> pio0_s1_translator:uav_burstcount
	wire          pio0_s1_agent_rf_source_valid;                                              // pio0_s1_agent:rf_source_valid -> pio0_s1_agent_rsp_fifo:in_valid
	wire  [103:0] pio0_s1_agent_rf_source_data;                                               // pio0_s1_agent:rf_source_data -> pio0_s1_agent_rsp_fifo:in_data
	wire          pio0_s1_agent_rf_source_ready;                                              // pio0_s1_agent_rsp_fifo:in_ready -> pio0_s1_agent:rf_source_ready
	wire          pio0_s1_agent_rf_source_startofpacket;                                      // pio0_s1_agent:rf_source_startofpacket -> pio0_s1_agent_rsp_fifo:in_startofpacket
	wire          pio0_s1_agent_rf_source_endofpacket;                                        // pio0_s1_agent:rf_source_endofpacket -> pio0_s1_agent_rsp_fifo:in_endofpacket
	wire          pio0_s1_agent_rsp_fifo_out_valid;                                           // pio0_s1_agent_rsp_fifo:out_valid -> pio0_s1_agent:rf_sink_valid
	wire  [103:0] pio0_s1_agent_rsp_fifo_out_data;                                            // pio0_s1_agent_rsp_fifo:out_data -> pio0_s1_agent:rf_sink_data
	wire          pio0_s1_agent_rsp_fifo_out_ready;                                           // pio0_s1_agent:rf_sink_ready -> pio0_s1_agent_rsp_fifo:out_ready
	wire          pio0_s1_agent_rsp_fifo_out_startofpacket;                                   // pio0_s1_agent_rsp_fifo:out_startofpacket -> pio0_s1_agent:rf_sink_startofpacket
	wire          pio0_s1_agent_rsp_fifo_out_endofpacket;                                     // pio0_s1_agent_rsp_fifo:out_endofpacket -> pio0_s1_agent:rf_sink_endofpacket
	wire          pio0_s1_agent_rdata_fifo_src_valid;                                         // pio0_s1_agent:rdata_fifo_src_valid -> pio0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] pio0_s1_agent_rdata_fifo_src_data;                                          // pio0_s1_agent:rdata_fifo_src_data -> pio0_s1_agent:rdata_fifo_sink_data
	wire          pio0_s1_agent_rdata_fifo_src_ready;                                         // pio0_s1_agent:rdata_fifo_sink_ready -> pio0_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_006_src_valid;                                                      // cmd_mux_006:src_valid -> pio0_s1_agent:cp_valid
	wire  [102:0] cmd_mux_006_src_data;                                                       // cmd_mux_006:src_data -> pio0_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                      // pio0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                    // cmd_mux_006:src_channel -> pio0_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                              // cmd_mux_006:src_startofpacket -> pio0_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                // cmd_mux_006:src_endofpacket -> pio0_s1_agent:cp_endofpacket
	wire          cpu0_data_master_agent_cp_valid;                                            // cpu0_data_master_agent:cp_valid -> router:sink_valid
	wire  [102:0] cpu0_data_master_agent_cp_data;                                             // cpu0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [102:0] cpu0_instruction_master_agent_cp_data;                                      // cpu0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [102:0] cpu0_debug_mem_slave_agent_rp_data;                                         // cpu0_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] epcs_epcs_control_port_agent_rp_data;                                       // epcs_epcs_control_port_agent:rp_data -> router_005:sink_data
	...
	wire          timer0_s1_agent_rp_valid;                                                   // timer0_s1_agent:rp_valid -> router_007:sink_valid
	wire  [102:0] timer0_s1_agent_rp_data;                                                    // timer0_s1_agent:rp_data -> router_007:sink_data
	wire          timer0_s1_agent_rp_ready;                                                   // router_007:sink_ready -> timer0_s1_agent:rp_ready
	wire          timer0_s1_agent_rp_startofpacket;                                           // timer0_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          timer0_s1_agent_rp_endofpacket;                                             // timer0_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          pio0_s1_agent_rp_valid;                                                     // pio0_s1_agent:rp_valid -> router_008:sink_valid
	wire  [102:0] pio0_s1_agent_rp_data;                                                      // pio0_s1_agent:rp_data -> router_008:sink_data
	wire          pio0_s1_agent_rp_ready;                                                     // router_008:sink_ready -> pio0_s1_agent:rp_ready
	wire          pio0_s1_agent_rp_startofpacket;                                             // pio0_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          pio0_s1_agent_rp_endofpacket;                                               // pio0_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [102:0] router_001_src_data;                                                        // router_001:src_data -> cpu0_instruction_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                       // cpu0_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [6:0] router_001_src_channel;                                                     // router_001:src_channel -> cpu0_instruction_master_limiter:cmd_sink_channel
	...
	wire  [102:0] cpu0_instruction_master_limiter_cmd_src_data;                               // cpu0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [6:0] cpu0_instruction_master_limiter_cmd_src_channel;                            // cpu0_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [102:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> cpu0_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                      // cpu0_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [6:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> cpu0_instruction_master_limiter:rsp_sink_channel
	...
	wire  [102:0] cpu0_instruction_master_limiter_rsp_src_data;                               // cpu0_instruction_master_limiter:rsp_src_data -> cpu0_instruction_master_agent:rp_data
	...
	wire    [6:0] cpu0_instruction_master_limiter_rsp_src_channel;                            // cpu0_instruction_master_limiter:rsp_src_channel -> cpu0_instruction_master_agent:rp_channel
	...
	wire    [6:0] cpu0_instruction_master_limiter_cmd_valid_data;                             // cpu0_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio0_s1_agent_m0_address),                    // avalon_universal_slave_0.address
		.uav_burstcount         (pio0_s1_agent_m0_burstcount),                 //                         .burstcount
		.uav_read               (pio0_s1_agent_m0_read),                       //                         .read
		.uav_write              (pio0_s1_agent_m0_write),                      //                         .write
		.uav_waitrequest        (pio0_s1_agent_m0_waitrequest),                //                         .waitrequest
		.uav_readdatavalid      (pio0_s1_agent_m0_readdatavalid),              //                         .readdatavalid
		.uav_byteenable         (pio0_s1_agent_m0_byteenable),                 //                         .byteenable
		.uav_readdata           (pio0_s1_agent_m0_readdata),                   //                         .readdata
		.uav_writedata          (pio0_s1_agent_m0_writedata),                  //                         .writedata
		.uav_lock               (pio0_s1_agent_m0_lock),                       //                         .lock
		.uav_debugaccess        (pio0_s1_agent_m0_debugaccess),                //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (cpu0_debug_mem_slave_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (cpu0_debug_mem_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (cpu0_debug_mem_slave_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (epcs_epcs_control_port_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (epcs_epcs_control_port_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (epcs_epcs_control_port_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (timer0_s1_agent_rdata_fifo_src_ready),        // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (timer0_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_sink_data    (timer0_s1_agent_rdata_fifo_src_data),         //                .data
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_clk_clk),                                 //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (pio0_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (pio0_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (pio0_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (pio0_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (pio0_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (pio0_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (pio0_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (pio0_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (pio0_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (pio0_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (pio0_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (pio0_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (pio0_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (pio0_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (pio0_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (pio0_s1_agent_rp_startofpacket),              //                .startofpacket
		...
		.rf_sink_ready           (pio0_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (pio0_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (pio0_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (pio0_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (pio0_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (pio0_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (pio0_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (pio0_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (pio0_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (pio0_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (pio0_s1_agent_rdata_fifo_src_ready),          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (pio0_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_sink_data    (pio0_s1_agent_rdata_fifo_src_data),           //                .data
		.rdata_fifo_src_ready    (pio0_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio0_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (pio0_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio0_s1_agent_rsp_fifo (
		.clk               (clk_clk_clk),                                 //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (pio0_s1_agent_rf_source_data),                //        in.data
		.in_valid          (pio0_s1_agent_rf_source_valid),               //          .valid
		.in_ready          (pio0_s1_agent_rf_source_ready),               //          .ready
		.in_startofpacket  (pio0_s1_agent_rf_source_startofpacket),       //          .startofpacket
		.in_endofpacket    (pio0_s1_agent_rf_source_endofpacket),         //          .endofpacket
		.out_data          (pio0_s1_agent_rsp_fifo_out_data),             //       out.data
		.out_valid         (pio0_s1_agent_rsp_fifo_out_valid),            //          .valid
		.out_ready         (pio0_s1_agent_rsp_fifo_out_ready),            //          .ready
		.out_startofpacket (pio0_s1_agent_rsp_fifo_out_startofpacket),    //          .startofpacket
		.out_endofpacket   (pio0_s1_agent_rsp_fifo_out_endofpacket),      //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	cpu2core_mm_interconnect_0_router_002 router_003 (
	...
	cpu2core_mm_interconnect_0_router_002 router_007 (
	...
	cpu2core_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (pio0_s1_agent_rp_ready),                      //      sink.ready
		.sink_valid         (pio0_s1_agent_rp_valid),                      //          .valid
		.sink_data          (pio0_s1_agent_rp_data),                       //          .data
		.sink_startofpacket (pio0_s1_agent_rp_startofpacket),              //          .startofpacket
		.sink_endofpacket   (pio0_s1_agent_rp_endofpacket),                //          .endofpacket
		.clk                (clk_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                            //       clk.clk
		.reset               (cpu0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                            //       clk.clk
		.reset               (cpu0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_clk_clk),                            //       clk.clk
		.reset              (cpu0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_clk_clk),                            //       clk.clk
		.reset              (cpu0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu2core_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_clk_clk),                                  //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
